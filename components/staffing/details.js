...
const Details = ({
  ...
  return (
    <div>
      <div className="w-[800px] bg-white border shadow-md px-4 py-4" >
          ...
          <div className="flex items-center space-x-4" >
            ...
            <div className="flex flex-col">
              <div className="flex items-center space-x-2">
                <p className="text-sm font-semibold first-letter:uppercase text-gray-800" >{name}</p>
        ...
        <p className="pt-5 px-2 text-gray-700 text-sm font-medium">{matter}</p>
        <div className="flex justify-between items-center pt-5" >
          <div className="flex flex-col space-y-2" >
            ...
            <div className="flex space-x-1">
              {skills.map((item) => {
                return <div className="bg-gray-100 px-2 text-[13px] text-gray-500 font-medium rounded py-1">{item}</div>;
              })}
            </div>
          </div>
          <div className="flex flex-col space-y-2">
            <div>
              <p className="text-sm text-gray-800 font-semibold">Also worked with</p>
            </div>
