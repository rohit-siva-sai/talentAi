    ...
    <div className="py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 px-4 md:px-48 justify-items-start align-top  ">
        <div className="    flex flex-col space-y-8 pr-12">
          <p className="font-semibold text-gray-800 font-serif text-4xl">
          ...
          <div className="flex flex-wrap pr-16 ">
            <div className="flex items-center rounded-3xl border mr-8  bg-lime-50 py-1 px-3 w-fit space-x-2">
            ...
            <div className="flex items-center rounded-3xl border mr-8 mt-4  bg-lime-50 py-1 px-3 w-fit space-x-2">
              <p className="text-gray-700 font-medium">Data Scientist</p>
              <FaArrowRight className="text-gray-600" size={15} />
            </div>
            <div className="flex items-center rounded-3xl border mt-4 bg-lime-50 py-1 px-3 w-fit space-x-2">
